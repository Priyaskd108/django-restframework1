...
urlpatterns = [
    ...
    path('comic-filtered/',comic_list_filtered_api_view ,name='comic_list_filtered_api_view'),
    path('comic-filtered_qty10/',comic_list_filtered_qty_api_view ,name='comic_list_filtered_qty_api_view')
]
